...
import static demo.yqh.dmdcspapp.MyApplication.sqldb;
    ...
    private void OpenCamera() {
        if (mIsKitKat) {
            ...
            if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                ...
                cameraFileUri = FileProvider.getUriForFile(AddHiddenDangerRegistration.this, "demo.yqh.dmdcspapp.fileprovider", picture);
