...
//    public static String host = "http://192.168.5.87:8080/DMHDCS_GYAJ/mobile/";
    ...
    //228
    public static String myUrl = "http://192.168.5.228:8098/DMDCSP/";
    public static String host = "http://192.168.5.228:8098/DMDCSP/mobile/";
...
//    public static String host = "http://220.170.143.52:8882/mobile/";
    ...
    //海峰
//    public static String myUrl = "http://192.168.5.103:8080/DMDCSP/";
//    public static String host = "http://192.168.5.103:8080/DMDCSP/mobile/";
    ...
    //隐患基本信息
    public static String HiddenInfo() {
        return host + "mobileHiddendangerinfo/list.action";
    }

    //重大隐患排查
    public static String HiddenGovernment() {
        return host + "mobileHiddendangebig/list.action";
    }

    //隐患整改信息
    public static String HiddenRectification() {
        return host + "mobileHiddendangerrectifica/list.action";
    }
}
